...
class TotalController extends Controller
{
    ...
    public function tampilPerBulan(Request $request)
    {
        ...
        return view('bulanan.tabelbulanan', compact('pemasukan', 'pengeluaran', 'tabungan', 'bulan', 'tahun', 'total_masuk', 'total_keluar', 'total_saldo_akhir'));
    }
    ...
    public function tampilPerTahun(Request $request)
{
    ...
    return view('tahunan.tabeltahunan', compact('pemasukan', 'pengeluaran', 'tabungan', 'tahun', 'total_masuk', 'total_keluar', 'total_saldo_akhir'));
}
